...
public class FeaturedAppsAdapter extends RecyclerView.Adapter<FeaturedAppsAdapter.MyViewHolderInst> {
    ...
    class MyViewHolderInst extends RecyclerView.ViewHolder {
        ...
        MyViewHolderInst(View view) {
            ...
            background.setBackground(ContextCompat.getDrawable(view.getContext(), R.drawable.featured_apps_default_gradient));
        }
    }


    public FeaturedAppsAdapter(List<FeaturedHolder> FeaturedAppsH) {
